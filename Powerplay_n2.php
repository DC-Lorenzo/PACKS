...
$query = "INSERT INTO elforodeltenis_descarga_powerplay ( id_usuario, fecha, version) VALUES ('$_GET[us]', '$fecha', '2')";
$po = new conexionBD();
$po -> doQuery("$query");
...
$mail->Subject = "Nueva descarga de la revista N.2 de Powerplay";
$mail->AddAddress('dcolja@elforodeltenis.com; pacoalmendros@ono.com');

$body = "<strong>El usuario $member_name se acaba de descargar el n&uacute;mero 2 de la revista Powerplay.<br><br>";
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <meta name="description" content="Venta de raquetas de tenis, zapatillas de tenis, ropa de tenis. Venta de segunda mano. Revista Powerplay N2">
    <title>ELFORODELTENIS.COM - Revista Powerplay N2</title>
...
<div class="row space-up">
	<div class="col-md-4 col-xs-12"><img src="http://packs.elforodeltenis.com/img/revista_powerplay_v2.jpg" width="100%" alt="elforodeltenis.com Revista Powerplay N2" title="Powerplay partner de el foro del tenis"></div>
	<div class="col-md-8 col-xs-12">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title">Descargar el n&uacute;mero 2 de la revista Powerplay</h3>
		</div>
			...
			<div class="row">
			  <div class="col-sm-6 col-md-4">
			    <div class="thumbnail">
			      ...
			      <div class="caption">
			        <h3>Revista n&deg; 2</h3>
			        <p>
			           	<a href="descargas/powerplay_tennis_n2.pdf" class="btn btn-danger"  target="_blank">Descargar</a>
			        </p>
			      </div>
			    </div>
			  </div>
